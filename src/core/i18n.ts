...
const messages: Record<string, Record<Locale, string>> = {
  ...
  // ── permissions ─────────────────────────────────────────
  "perm.requestAccess": {
    en: "Agent wants to access {0}. Allow? (y/n): ",
    ko: "에이전트가 {0} 에 접근하려 합니다. 허용하시겠습니까? (y/n): ",
    ja: "エージェントが {0} にアクセスしようとしています。許可しますか？ (y/n): ",
    zh: "代理要访问 {0}。允许吗？(y/n): ",
    es: "El agente quiere acceder a {0}. Permitir? (y/n): ",
    fr: "L'agent veut acceder a {0}. Autoriser? (y/n): ",
    de: "Der Agent moechte auf {0} zugreifen. Erlauben? (y/n): ",
    it: "L'agente vuole accedere a {0}. Consentire? (y/n): ",
  },
  "perm.savePermanent": {
    en: "Save permanently? (y/n): ",
    ko: "영구적으로 저장하시겠습니까? (y/n): ",
    ja: "永続的に保存しますか？ (y/n): ",
    zh: "永久保存吗？(y/n): ",
    es: "Guardar permanentemente? (y/n): ",
    fr: "Sauvegarder definitivement? (y/n): ",
    de: "Dauerhaft speichern? (y/n): ",
    it: "Salvare permanentemente? (y/n): ",
  },
  "perm.granted": {
    en: "Access granted.",
    ko: "접근이 허용되었습니다.",
  ...
  "perm.grantedPermanent": {
    en: "Access granted (permanent).",
    ko: "접근이 허용되었습니다 (영구 저장).",
    ja: "アクセスが許可されました（永続）。",
    zh: "访问已授权（永久）。",
    es: "Acceso concedido (permanente).",
    fr: "Acces accorde (permanent).",
    de: "Zugriff gewaehrt (dauerhaft).",
    it: "Accesso concesso (permanente).",
  },
  "perm.grantedSession": {
    en: "Access granted (session only).",
    ko: "접근이 허용되었습니다 (이번 세션만).",
    ja: "アクセスが許可されました（今回のセッションのみ）。",
    zh: "访问已授权（仅本次会话）。",
    es: "Acceso concedido (solo esta sesion).",
    fr: "Acces accorde (session uniquement).",
    de: "Zugriff gewaehrt (nur fuer diese Sitzung).",
    it: "Accesso concesso (solo questa sessione).",
  },
  "perm.allowSession": {
    en: "Allow (session)",
    ko: "허용 (세션)",
    ...
    zh: "允许（会话）",
    es: "Permitir (sesion)",
    fr: "Autoriser (session)",
    de: "Erlauben (Sitzung)",
    it: "Consenti (sessione)",
  },
  "perm.allowPermanent": {
    en: "Allow (permanent)",
    ko: "허용 (영구)",
    ja: "許可（永続）",
    zh: "允许（永久）",
    es: "Permitir (permanente)",
    fr: "Autoriser (permanent)",
    de: "Erlauben (dauerhaft)",
    it: "Consenti (permanente)",
  },
  "perm.deny": {
    en: "Deny",
    ko: "거부",
